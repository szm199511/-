...
<body>
 ...
 <li>
	...
	<table >
			...
			</tr><form action="userController/onlinejudgeresult.do" method="post">
			<c:forEach var="problem" items="${allpro }" varStatus="s">
				<tr>
					...
					<td>
					   <input type="hidden" name="answer1" value="${problem.answer}">
					</td>
					<td>
					   <input type="hidden" name="id" value="${problem.problem}">
					</td>
				</tr>
			</c:forEach>
